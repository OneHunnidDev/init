...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x000005646578b5296aa0e2a8e59673b664cc8ee921f51b910e77fbb7bfcccdcb");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // OneHunnid: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "OneHunnid Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000005646578b5296aa0e2a8e59673b664cc8ee921f51b910e77fbb7bfcccdcb");
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("OneHunnidMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("OneHunnidCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("OneHunnidMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("OneHunnid-miner");
    ...
    try { loop {
        ...
        printf("Running OneHunnidMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("OneHunnidMiner terminated\n");
        throw;
    }
}
